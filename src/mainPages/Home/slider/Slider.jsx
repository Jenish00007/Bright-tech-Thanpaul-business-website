                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item active">
                        <div className="row slide-part align-items-center">
                            ...
                            <div className="col-md-6 col-12 text-center">
                                <img src="/assets/girl2.webp" className="slide-image img-fluid w-100" alt="Jewellery" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="carousel-item">
                        <div className="row slide-part align-items-center">
                            ...
                            {/* Image Section */}
                            <div className="col-md-6 col-12 text-center">
                                <img src="/assets/girl.webp" className="slide-image img-fluid w-100" alt="Jewellery" />
                            </div>
                        </div>
                    </div>
                       ...
                       <div className="carousel-item">
                        <div className="row slide-part align-items-center">
                            ...
                            {/* Image Section */}
                            <div className="col-md-6 col-12 text-center">
                                <img src="/assets/girl3.webp" className="slide-image img-fluid w-100" alt="Jewellery" />
                            </div>
                        </div>
                    </div>
                </div>
